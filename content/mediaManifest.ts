...
export const mediaManifest: ManifestItem[] = [
  ...
  // ---- Trusted-client logos (standardized, black→alpha trimmed) ----
  ...([
    ['yamaha-logo', 'Yamaha', 599, 129, 45],
    ['ses-logo', 'Sindhudurg Education Society', 858, 227, 60],
    ['divija-logo', 'Divija Old Age Home', 397, 520, 78],
    ['wet-n-joy-logo', 'WetNJoy', 600, 226, 130],
    ['askara-group-logo', 'Askara Group', 620, 161, 173],
    ['dji-logo', 'DJI', 500, 289, 29],
    ['dave-and-busters-logo', 'Dave and Busters', 460, 460, 112],
    ['election-commission-india-logo', 'Election Commission of India', 392, 391, 74],
    ['imagicaa-logo', 'Imagicaa', 600, 252, 97],
    ['nhai-logo', 'NHAI', 540, 357, 145],
    ['volkswagen-logo', 'Volkswagen', 420, 420, 55],
    ...
    kind: 'image' as const,
    actual: true,
    oldSource: `public/logos/optimized/${file}.png`,
    src: `/logos/optimized/${file}.png`,
    width: w,
    height: h,
    aspect: `${w}:${h}`,
    sizeKB: kb,
